...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8 scale-95">
            <h1 className="text-4xl font-semibold underline cursor-pointer mb-4 font-mono">About Get Me a Chai</h1>
